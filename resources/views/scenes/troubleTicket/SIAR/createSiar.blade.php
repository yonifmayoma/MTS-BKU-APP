                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Create Siar Trouble Ticket</h4>
                            </div>
                        </div>
                        <div>
                            <form action="{{ route('siartroubleticket.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group text-start">
                                    ...
                                    <a href="{{ route('siartroubleticket.index') }}" class="btn btn-secondary ms-3">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        document.getElementById('submit-btn').addEventListener('click', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('siartroubleticket-form').submit();
                }
            })
        });
    </script>
