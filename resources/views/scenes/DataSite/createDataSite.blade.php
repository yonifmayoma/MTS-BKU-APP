...
<div class="container">
    ...
    <form action="{{ route('datasites.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="spotbeam" name="spotbeam" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="vsat" name="vsat" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="oa" name="oa" required>
        </div>
